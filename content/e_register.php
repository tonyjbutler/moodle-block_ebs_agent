...
//Opening tags generated by print_header which need to be closed
# <html> 
# <body>
	# <div>
?>		
		...
		<form action="e_register_handler.php" method="post" name="register_form" onsubmit="return do_register_marking_validation(this);">
			...
			<div class="ebs_register_footer">			
				<div class="options">
					...
					?>
						<strong>Yes</strong>
						| <a href="<?php echo get_page_url(true, $display_photos); ?>" title="Show all learners on this e-register.">No</a>,
					<?php
					}					
					?>					
					show learner photos: 
					...
					?>
						<strong>Yes</strong> |
						<a href="<?php echo get_page_url($include_inactive, false); ?>" title="Hide learner photos.">No</a>,
					<?php
					} else {
					?>
					...
					?>
					<a href="javascript:add_new_learner(<?php echo $alternate ? "true" : "false"; ?>, <?php echo $display_photos ? "true" : "false"; ?>,'<?php echo $default_progress_code["Code"]; ?>');" alt="Add learner to e-register." title="Add learner to e-register.">add new learner</a>
				</div>
